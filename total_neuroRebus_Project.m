function total_neuroRebus_Project(subject, run, output, practice, dev, log)
    ...
    % Font size for instruction screens
    if dev
        INSTRUCTION_SIZE = 16;
    else
        INSTRUCTION_SIZE = 32;
    ...
    Screen('TextSize', window, INSTRUCTION_SIZE);

    instructions = {

        ['During this experiment, you will see sentences that appear ' ...
        'on the screen one word at a time.' newline newline ...
        'One of the words in each sentence will appear as a black and white picture.' ...
        newline newline ...
    ...
    ,
        ...
        ['At the end of each sentence, you will be asked whether the sentence is ' ...
        'plausible or implausible.' newline newline ...
    ...
    ,
        ...
        ['You will respond using the button box.' ...
        newline newline ...
        '1 = Yes' ...
        newline ...
        '2 = No' ...
        newline newline ...
        'Press the button only when instructed to do so.' ...
        newline newline ...
        'Press ENTER to continue.']

    ,

        ['You will also see a plus sign (+) between sentences.' ...
        newline newline ...
        'If you have any questions, please ask the experimenter before the scan begins.' ...
        newline newline ...
        'Once the task starts, try to remain still and continue following the instructions on the screen.' ...
        newline newline ...
    ...
    % Switch back to experiment font size
